...
eval "$CC -c $CFLAGS_C \"$A64_DIR/virtio_a64.c\" -o \"$BUILD_DIR/virtio_a64.o\""
eval "$CC -c $CFLAGS_C \"$A64_DIR/kfdt.c\"        -o \"$BUILD_DIR/kfdt.o\""
eval "$CC -c $CFLAGS_C \"$A64_DIR/fdt_boot.c\"    -o \"$BUILD_DIR/fdt_boot.o\""
...
eval "$CC -c $CFLAGS_C \"$KERNEL_DIR/kf_prophet.c\"   -o \"$BUILD_DIR/kf_prophet.o\""
...
OBJS=("$BUILD_DIR/start64.o" "$BUILD_DIR/vectors.o"
      ...
      "$BUILD_DIR/usb_a64.o" "$BUILD_DIR/disk_a64.o" "$BUILD_DIR/virtio_a64.o"
      "$BUILD_DIR/kfdt.o" "$BUILD_DIR/fdt_boot.o"
