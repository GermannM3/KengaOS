...
### Этап 3 — Oppo A5 2020 (CPH1931, Qualcomm SM6125 / Snapdragon 665)

Целевое железо подтверждено. Хорошая новость: SM6125 — один из самых
поддержанных Qualcomm-чипов в mainline Linux (референсы: Sony Xperia 10 II,
порты postmarketOS). Значит: DTB, адреса устройств и обходные пути
известны, изобретать не надо.
